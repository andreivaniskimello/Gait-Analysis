...
% SECTION 07: LOWER LEG (LL) MODEL
% SECTION 08: FOOT (FT) MODEL
% SECTION 09: DRAG FORCES SUMMATION
% SECTION 10: GROUND REACTION FORCES 
% SECTION 11: ESTIMATION ALGORITHM FOR AUTOMATIC TOUCH DOWN AND TAKE OFF EVENTS 
% SECTION 12: EXPORT DATA GRAPHICS AND GIFS
% SECTION 13: GRAPHICS AND GIFS
...
File_Name =['Edson_Joelho_0.6_P1_Teste'];        %insert 'SubjectName_Depth_Speed_StrideNumber' here, in order to export the final data with the Subject Name_Depth 
...
Walk_Linear_file = ('C:\Users\andre\Documents\Mestrado\Projetos Pesquisa\Projeto Marcha Água\Coletas\Data\Cinemetria\Data Out\SkillSpector\Edson\Joelho\Edson_Joelho_0.6_P1_Positions.txt');
delimiterIn = '\t';
Linear_Data = importdata(Walk_Linear_file,delimiterIn);
Linear_Data = Linear_Data.';

%Insert Export (Output) File Path here
Export_File_Path = ['C:\Users\andre\Documents\Mestrado\Projetos Pesquisa\Projeto Marcha Água\Coletas\Data\Cinemetria\Data Out\MatLab\Edson\Joelho'];     
...
Foot_Angular_Speed_100_Stride_Filter = matfiltfilt(dt, fcut, order, Foot_Angular_Speed_100_Stride);
...
F_Contact_Total = RMS_F_LL_Contact + RMS_F_FT_Contact;
F_Swing_Total = RMS_F_LL_Swing + RMS_F_FT_Swing;
...
Export_Data_Angular = [Foot_Angle_ROM Shank_Angle_ROM Foot_Angular_Speed_Max Shank_Angular_Speed_Max Ankle_Joint_Angle_ROM Ankle_Joint_Angular_Speed_Max];
Export_Header_Angular = {'Foot_Angle_ROM (º)', 'Shank_Angle_ROM (º)', 'Foot_Angular_Speed_Max (º/s)', 'Shank_Angular_Speed_Max (º/s)', 'Ankle_Joint_Angle_ROM (º)', 'Ankle_Joint_Angular_Speed_Max (º/s)'};
...
Export_Data_Coordination = [Relative_Phase_Foot_Shank Coupling_Angle_Shank_Foot_Stride Coupling_Angle_Shank_Foot_Contact Coupling_Angle_Shank_Foot_Swing  Foot_Linear_Speed_100_Stride Foot_Angular_Speed_100_Stride Shank_Linear_Speed_100_Stride Shank_Angular_Speed_100_Stride];
Export_Header_Coordination = {'Relative_Phase_Foot_Shank', 'Coupling_Angle_Shank_Foot_Stride', 'Coupling_Angle_Shank_Foot_Contact', 'Coupling_Angle_Shank_Foot_Swing', 'Foot_Linear_Speed_100_Stride', 'Foot_Angular_Speed_100_Stride', 'Shank_Linear_Speed_100_Stride', 'Shank_Angular_Speed_100_Stride'};
...
Export_Data_Kinetic_Detailed= [RMS_F_LL_Contact RMS_F_LL_Swing RMS_F_FT_Contact RMS_F_FT_Swing RMS_F_LL_AreaNormalized_Contact RMS_F_LL_AreaNormalized_Swing RMS_F_FT_AreaNormalized_Contact RMS_F_FT_AreaNormalized_Swing  RMS_F_LL_WeightNormalized_Contact RMS_F_LL_WeightNormalized_Swing RMS_F_FT_WeightNormalized_Contact RMS_F_FT_WeightNormalized_Swing];
Export_Header_Kinetic_Detailed = {'RMS_F_LL_Contact (N)', 'RMS_F_LL_Swing (N)', 'RMS_F_FT_Contact (N)', 'RMS_F_FT_Swing (N)', 'RMS_F_LL_AreaNormalized_Contact(N/m2)', 'RMS_F_LL_AreaNormalized_Swing(N/m2)', 'RMS_F_FT_AreaNormalized_Contact(N/m2)', 'RMS_F_FT_AreaNormalized_Swing(N/m2)', 'RMS_F_LL_WeightNormalized_Contact(%N/BW)', 'RMS_F_LL_WeightNormalized_Swing(%N/BW)', 'RMS_F_FT_WeightNormalized_Contact(%N/BW)', 'RMS_F_FT_WeightNormalized_Swing(%N/BW)'};
...
Data_Curves100_Angular = [Foot_Angle_100_Stride Foot_Angle_100_Contact Foot_Angle_100_Swing Shank_Angle_100_Stride Shank_Angle_100_Contact Shank_Angle_100_Swing Ankle_Joint_Angle_100_Stride Ankle_Joint_Angle_100_Contact Ankle_Joint_Angle_100_Swing];
Header_Curves100_Angular = {'Foot_Angle_100_Stride (º)', 'Foot_Angle_100_Contact (º)', 'Foot_Angle_100_Swing (º)', 'Shank_Angle_100_Stride (º)', 'Shank_Angle_100_Contact (º)', 'Shank_Angle_100_Swing (º)', 'Ankle_Joint_Angle_100_Stride (º)', 'Ankle_Joint_Angle_100_Contact (º)', 'Ankle_Joint_Angle_100_Swing (º)'};
...
Data_Curves100_Kinetic_Absolute = [F_LL_100_Stride F_LL_100_Contact F_LL_100_Swing F_FT_100_Stride F_FT_100_Contact F_FT_100_Swing ];
Header_Curves100_Kinetic_Absolute = {'F_LL_100_Stride (N)', 'F_LL_100_Contact (N)', 'F_LL_100_Swing (N)', 'F_FT_100_Stride (N)', 'F_FT_100_Contact (N)', 'F_FT_100_Swing (N)'};
...
Data_Curves100_Kinetic_Normalized_Weight = [F_LL_WeightNormalized_100_Stride F_LL_WeightNormalized_100_Contact F_LL_WeightNormalized_100_Swing F_FT_WeightNormalized_100_Stride F_FT_WeightNormalized_100_Contact F_FT_WeightNormalized_100_Swing];
Header_Curves100_Kinetic_Normalized_Weight = {'F_LL_WeightNormalized_100_Stride(%N/BW)', 'F_LL_WeightNormalized_100_Contact(%N/BW)', 'F_LL_WeightNormalized_100_Swing(%N/BW)', 'F_FT_WeightNormalized_100_Stride(%N/BW)', 'F_FT_WeightNormalized_100_Contact(%N/BW)', 'F_FT_WeightNormalized_100_Swing(%N/BW)'};
...
Data_Curves100_Kinetic_Normalized_Area = [F_LL_AreaNormalized_100_Stride F_LL_AreaNormalized_100_Contact F_LL_AreaNormalized_100_Swing F_FT_AreaNormalized_100_Stride F_FT_AreaNormalized_100_Contact F_FT_AreaNormalized_100_Swing];
Header_Curves100_Kinetic_Normalized_Area = {'F_LL_AreaNormalized_100_Stride(N/m2)', 'F_LL_AreaNormalized_100_Contact(N/m2)', 'F_LL_AreaNormalized_100_Swing(N/m2)', 'F_FT_AreaNormalized_100_Stride(N/m2)', 'F_FT_AreaNormalized_100_Contact(N/m2)', 'F_FT_AreaNormalized_100_Swing(N/m2)'};
...
hold on
legend ('Shank Contact','Shank Swing', 'TD')
