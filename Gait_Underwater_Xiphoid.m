...
File_Name =['Edson_Xifoide_VAS_P5'];        %insert 'SubjectName_Depth_Speed_StrideNumber' here, in order to export the final data with the Subject Name_Depth 
...
Walk_Linear_file = ('C:\Users\andre\Documents\Mestrado\Projetos Pesquisa\Projeto Marcha Água\Coletas\Data\Cinemetria\Data Out\SkillSpector\Edson\Xifoide\Edson_Xifoide_VAS_P5_Positions.txt');
delimiterIn = '\t';
Linear_Data = importdata(Walk_Linear_file,delimiterIn);
Linear_Data = Linear_Data.';

%Insert Export (Output) File Path here
Export_File_Path = ['C:\Users\andre\Documents\Mestrado\Projetos Pesquisa\Projeto Marcha Água\Coletas\Data\Cinemetria\Data Out\MatLab\Edson\Xifoide\VAS'];     
...
for i=1:Frames 
    if Foot_Angle(i) < 0 
        Foot_Angle(i) = abs(Foot_Angle(i)+90) + 90;
    else
...
for i=1:length(Shank_Angle);
   for j=1:length(dA_LL);
     dAP_LL(i,j)= dA_LL(j)*sind(abs(Shank_Angle(i)));
   end
end
...
for i=1:length(Foot_Angle);
    for j=1:length(dA_FT);
      dAP_FT(i,j)=dA_FT(j)*sind(abs(Foot_Angle(i)));
    end
end
...
Export_Data_Kinetic_Detailed= [RMS_F_Xiph_Contact RMS_F_Xiph_Swing RMS_F_UL_Contact RMS_F_UL_Swing RMS_F_LL_Contact RMS_F_LL_Swing RMS_F_FT_Contact RMS_F_FT_Swing RMS_F_Xiph_AreaNormalized_Contact RMS_F_Xiph_AreaNormalized_Swing RMS_F_UL_AreaNormalized_Contact RMS_F_UL_AreaNormalized_Swing RMS_F_LL_AreaNormalized_Contact RMS_F_LL_AreaNormalized_Swing RMS_F_FT_AreaNormalized_Contact RMS_F_FT_AreaNormalized_Swing RMS_F_Xiph_WeightNormalized_Contact RMS_F_Xiph_WeightNormalized_Swing RMS_F_UL_WeightNormalized_Contact RMS_F_UL_WeightNormalized_Swing RMS_F_LL_WeightNormalized_Contact RMS_F_LL_WeightNormalized_Swing RMS_F_FT_WeightNormalized_Contact RMS_F_FT_WeightNormalized_Swing];
Export_Header_Kinetic_Detailed = {'RMS_F_Xiph_Contact (N)','RMS_F_Xiph_Swing (N)', 'RMS_F_UL_Contact (N)','RMS_F_UL_Swing (N)','RMS_F_LL_Contact (N)', 'RMS_F_LL_Swing (N)', 'RMS_F_FT_Contact (N)', 'RMS_F_FT_Swing (N)','RMS_F_Xiph_AreaNormalized_Contact(N/m2)', 'RMS_F_Xiph_AreaNormalized_Swing(N/m2)', 'RMS_F_UL_AreaNormalized_Contact(N/m2)', 'RMS_F_UL_AreaNormalized_Swing(N/m2)', 'RMS_F_LL_AreaNormalized_Contact(N/m2)', 'RMS_F_LL_AreaNormalized_Swing(N/m2)', 'RMS_F_FT_AreaNormalized_Contact(N/m2)', 'RMS_F_FT_AreaNormalized_Swing(N/m2)', 'RMS_F_Xiph_WeightNormalized_Contact(%N/BW)', 'RMS_F_Xiph_WeightNormalized_Swing(%N/BW)', 'RMS_F_UL_WeightNormalized_Contact(%N/BW)', 'RMS_F_UL_WeightNormalized_Swing(%N/BW)', 'RMS_F_LL_WeightNormalized_Contact(%N/BW)', 'RMS_F_LL_WeightNormalized_Swing(%N/BW)', 'RMS_F_FT_WeightNormalized_Contact(%N/BW)', 'RMS_F_FT_WeightNormalized_Swing(%N/BW)'};
...
Data_Curves100_Kinetic_Absolute = [F_Xiph_100_Stride F_Xiph_100_Contact F_Xiph_100_Swing F_UL_100_Stride F_UL_100_Contact F_UL_100_Swing F_LL_100_Stride F_LL_100_Contact F_LL_100_Swing F_FT_100_Stride F_FT_100_Contact F_FT_100_Swing ];
Header_Curves100_Kinetic_Absolute = {'F_Xiph_100_Stride (N)', 'F_Xiph_100_Contact (N)', 'F_Xiph_100_Swing (N)', 'F_UL_100_Stride (N)', 'F_UL_100_Contact (N)', 'F_UL_100_Swing (N)', 'F_LL_100_Stride (N)', 'F_LL_100_Contact (N)', 'F_LL_100_Swing (N)', 'F_FT_100_Stride (N)', 'F_FT_100_Contact (N)', 'F_FT_100_Swing (N)'};
...
Data_Curves100_Kinetic_Normalized_Weight = [F_Xiph_WeightNormalized_100_Stride F_Xiph_WeightNormalized_100_Contact F_Xiph_WeightNormalized_100_Swing F_UL_WeightNormalized_100_Stride F_UL_WeightNormalized_100_Contact F_UL_WeightNormalized_100_Swing F_LL_WeightNormalized_100_Stride F_LL_WeightNormalized_100_Contact F_LL_WeightNormalized_100_Swing F_FT_WeightNormalized_100_Stride F_FT_WeightNormalized_100_Contact F_FT_WeightNormalized_100_Swing];
Header_Curves100_Kinetic_Normalized_Weight = {'F_Xiph_WeightNormalized_100_Stride(%N/BW)', 'F_Xiph_WeightNormalized_100_Contact(%N/BW)', 'F_Xiph_WeightNormalized_100_Swing(%N/BW)', 'F_UL_WeightNormalized_100_Stride(%N/BW)', 'F_UL_WeightNormalized_100_Contact(%N/BW)', 'F_UL_WeightNormalized_100_Swing(%N/BW)', 'F_LL_WeightNormalized_100_Stride(%N/BW)', 'F_LL_WeightNormalized_100_Contact(%N/BW)', 'F_LL_WeightNormalized_100_Swing(%N/BW)', 'F_FT_WeightNormalized_100_Stride(%N/BW)', 'F_FT_WeightNormalized_100_Contact(%N/BW)', 'F_FT_WeightNormalized_100_Swing(%N/BW)'};
...
ylabel ('Drag Force (N)');
hold on
plot(Time_Vector_Percentage(1:TO_in_Percentage),F_Xiph_100_Stride(1:TO_in_Percentage),'b:','LineWidth',3.0);
hold on
plot(Time_Vector_Percentage(TO_in_Percentage:end), F_Xiph_100_Stride(TO_in_Percentage:end),'r:','LineWidth',3.0);
hold on
